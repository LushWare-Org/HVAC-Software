...
Plus a separate Python ML tier at the repo root (`agent/`, `analytics/`, `api/`, `models/*.pkl`) running multi-armed bandits for followup, retention, upsell, revenue. `apps/agent-service/` is an empty placeholder.
