-- Marketing schema: full init
-- Applied manually via Supabase SQL Editor on 2026-05-12
...
CREATE TABLE IF NOT EXISTS "marketing"."campaigns" (
  ...
  "channel" "marketing"."MarketingChannel" NOT NULL, "status" TEXT NOT NULL DEFAULT 'DRAFT',
  "audienceId" TEXT, "templateId" TEXT, "scheduleAt" TIMESTAMPTZ, "createdBy" TEXT NOT NULL,
  "createdAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT "campaigns_pkey" PRIMARY KEY ("id")
);

CREATE TABLE IF NOT EXISTS "marketing"."templates" (
  "id" TEXT NOT NULL, "companyId" TEXT NOT NULL, "channel" "marketing"."MarketingChannel" NOT NULL,
  "name" TEXT NOT NULL, "subject" TEXT, "htmlBody" TEXT, "smsBody" TEXT,
  "mergeTagsJson" TEXT NOT NULL DEFAULT '[]', "isDefault" BOOLEAN NOT NULL DEFAULT false,
  "createdAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS "marketing"."audiences" (
  ...
  "filtersJson" TEXT NOT NULL DEFAULT '{}', "lastCount" INTEGER NOT NULL DEFAULT 0,
  "createdAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT "audiences_pkey" PRIMARY KEY ("id")
);

CREATE TABLE IF NOT EXISTS "marketing"."send_jobs" (
  "id" TEXT NOT NULL, "campaignId" TEXT, "companyId" TEXT NOT NULL, "customerId" TEXT NOT NULL,
  "channel" "marketing"."MarketingChannel" NOT NULL, "address" TEXT NOT NULL,
  "status" "marketing"."SendJobStatus" NOT NULL DEFAULT 'PENDING',
  "scheduledAt" TIMESTAMPTZ, "sentAt" TIMESTAMPTZ, "externalId" TEXT,
  "automationTemplate" TEXT, "error" TEXT,
  "createdAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT "send_jobs_pkey" PRIMARY KEY ("id")
);

CREATE TABLE IF NOT EXISTS "marketing"."send_events" (
  "id" TEXT NOT NULL, "sendJobId" TEXT NOT NULL,
  "eventType" "marketing"."SendEventType" NOT NULL,
  "eventAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(), "urlClicked" TEXT,
...
CREATE TABLE IF NOT EXISTS "marketing"."suppressions" (
  "id" TEXT NOT NULL, "companyId" TEXT NOT NULL, "channel" "marketing"."MarketingChannel" NOT NULL,
  "address" TEXT NOT NULL, "reason" "marketing"."SuppressionReason" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "marketing"."review_requests" (
  ...
  "gateScore" DOUBLE PRECISION, "smsAt" TIMESTAMPTZ, "emailAt" TIMESTAMPTZ,
  "createdAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT "review_requests_pkey" PRIMARY KEY ("id")
);

CREATE TABLE IF NOT EXISTS "marketing"."marketing_attributions" (
  "id" TEXT NOT NULL, "companyId" TEXT NOT NULL, "customerId" TEXT NOT NULL,
  "jobId" TEXT, "invoiceId" TEXT, "source" TEXT NOT NULL, "adName" TEXT, "formId" TEXT,
  "clickedAt" TIMESTAMPTZ, "revenueAttributed" DECIMAL(10,2) NOT NULL DEFAULT 0,
  "createdAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT "marketing_attributions_pkey" PRIMARY KEY ("id")
);

ALTER TABLE "marketing"."send_jobs" ADD CONSTRAINT "send_jobs_campaignId_fkey"
  FOREIGN KEY ("campaignId") REFERENCES "marketing"."campaigns"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "marketing"."send_events" ADD CONSTRAINT "send_events_sendJobId_fkey"
